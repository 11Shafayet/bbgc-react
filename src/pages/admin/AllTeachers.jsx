...
const AllTeachers = () => {
  ...
  const { data, isLoading, refetch } = useQuery({
    queryKey: ['post'],
    queryFn: async () => {
      const res = await axios.get(`https://bbgc-backend.vercel.app/teachers/`);
      return res.data;
    },
  });
  ...
  const handleDelete = async (teacherId) => {
    try {
      const response = await axios.delete(
        `https://bbgc-backend.vercel.app/teachers/${teacherId}`
      );
      ...
      toast.success('Failed to delete Teacher Data!');
    } finally {
      refetch();
    }
  };
        ...
        {isLoading ? (
          ...
          <Table striped className="relative">
            <Table.Head>
              ...
              <Table.HeadCell className="text-start">Department</Table.HeadCell>
              <Table.HeadCell className="text-start">
                Designation
              </Table.HeadCell>
              <Table.HeadCell className="text-start">Mobile</Table.HeadCell>
